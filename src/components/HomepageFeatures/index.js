...
const FeatureList = [
  {
    ...
    description: (
      <>
        LPC was designed from the ground up to be easily installed and used to
  ...
  {
    title: ">7.5k",
    Svg: require("@site/static/img/total_users.svg").default,
    description: <>New Users per Week</>,
  },
  {
    title: ">47.4M",
    Svg: require("@site/static/img/total_pageviews.svg").default,
    description: <>Total Pageviews</>,
  },
  {
    title: "87 and counting",
